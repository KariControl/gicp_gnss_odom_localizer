...
def generate_launch_description():
    ...
    gyro_odometer_deskewed = ComposableNode(
    ...
    gyro_odometer_direct = ComposableNode(
        package="pure_lidar_gyro_odometer",
        plugin="pure_gyro_odometer::GyroOdometerNode",
        name="gyro_odometer",
        parameters=[
    ...
    container_deskew = ComposableNodeContainer(
        condition=IfCondition(use_imu_deskew),
        name="pure_odometry_container",
        namespace="",
        package="rclcpp_components",
        executable="component_container_mt",
        composable_node_descriptions=[imu_undistorter, gyro_odometer_deskewed],
        output="screen",
        arguments=["--ros-args", "--log-level", log_level],
    )
    container_direct = ComposableNodeContainer(
        condition=UnlessCondition(use_imu_deskew),
        name="pure_odometry_container",
        namespace="",
        package="rclcpp_components",
        executable="component_container_mt",
        composable_node_descriptions=[gyro_odometer_direct],
        output="screen",
        arguments=["--ros-args", "--log-level", log_level],
    )
